...
import {
  Center, FormControl, FormLabel, Grid, GridItem,HStack, Input, ListItem,
   NumberDecrementStepper, NumberIncrementStepper, NumberInput,
  NumberInputField, NumberInputStepper, OrderedList,Radio,Box,RadioGroup,
  SimpleGrid,VStack, Button, useToast,Stack,
...
const AddUpdate = () => {
  ...
  const {
    id, mrpRange, sellingPriceRange, discountRange, name, brand, url,imagePath,altImagePath, otherImages,
    promotions, moreColors, isNew, sizeChartId, skus, video, allImages,specs, remain_qnty, sapStyleId,
    productTags,
    // productTags: [{ tagText, tagUrl, tagTextColor }],
    imageColor,} = productData;
